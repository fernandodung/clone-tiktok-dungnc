...
export const PlusIcon = ({ className, width = '1em', height = '1em' }) => (
    <svg
...
export const SearchIcon = ({ className, width = '1em', height = '1em' }) => (
    <svg
        className={cx(className)}
        width={width}
        height={height}
...
export const FeedbackIcon = ({ className, width = '1em', height = '1em' }) => (
    <svg
        className={cx(className)}
        width={width}
        height={height}
...
export const DarkmodeIcon = ({ className, width = '1em', height = '1em' }) => (
    <svg
        className={cx(className)}
        width={width}
        height={height}
